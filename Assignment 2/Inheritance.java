            ...
            switch (choice) {
                case 1 -> {
                    ...
                    while (true) {
                        ...
                        emp1.setName(name);
                        if (emp1.name != null) { // Check if the name was set successfully
                            break;
                        }
                    }
                    ...
                    while (true) {
                        int age = getValidIntegerInput(myobj, "Enter the age of the employee: ");
                        if (age >= 20 && age <= 60) {
                            emp1.setAge(age);
                            break;
                        } else {
                    ...
                    while (true) {
                        int salary = getValidIntegerInput(myobj, "Enter the salary of the employee: ");
                        if (salary > 10000) {
                            emp1.setSalary(salary);
                            break;
                        } else {
                            System.out.println("Salary must be a positive integer and greater than 10000.");
                        }
                    }
